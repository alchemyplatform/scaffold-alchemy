...
type Client = ReturnType<typeof useClient>["client"];
// Get all the image urls for all the NFTs an address owns.
async function displayWizards(client: Client | undefined, address: string | undefined) {
  const items = [];
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    console.log("TEsting", { client: !!client, address });
    displayWizards(client, address).then(xs => setNfts(xs));
  }, [!!client, address]);
